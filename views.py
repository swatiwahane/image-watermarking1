...
def index():
    if request.method=="GET":
        full_file_name='images/white_bg.jpg'
    ...
    if option =='logo_watermark':
        ...
        return render_template('index.html',full_filename)
    else:
        text_mark=request.form['text_mark']
        cv2.putText(image_logow,text=text_mark,org=(w_image-95,h_iamge-10),
        color=(0,0,255),thickness=2,lineTpe=cv2.LINE_4);
